...
export const vivaWalletHandlers = [
  ...
  http.post('https://demo.vivapayments.com/api/payment', async ({ request }) => {
  ...
  http.get('https://demo.vivapayments.com/api/payment/:transactionId', ({ params }) => {
  ...
  http.post('https://demo.vivapayments.com/api/payment/:transactionId/cancel', ({ params }) => {
    const { transactionId } = params
