...
describe('DeleteRoleDialog', () => {
  it('renders nothing when role is null', () => {
    const { container } = render(
      <DeleteRoleDialog role={null} open={true} onOpenChange={vi.fn()} onConfirm={vi.fn()} />
    )
  ...
  it('shows role displayName in confirmation message', () => {
    ...
    render(<DeleteRoleDialog role={role} open={true} onOpenChange={vi.fn()} onConfirm={vi.fn()} />)
  ...
  it('calls onOpenChange when Cancel is clicked', async () => {
    ...
    render(
      <DeleteRoleDialog role={role} open={true} onOpenChange={onOpenChange} onConfirm={vi.fn()} />
    )
  ...
  it('calls onConfirm with roleId when Delete is clicked', async () => {
    ...
    render(
      <DeleteRoleDialog role={role} open={true} onOpenChange={vi.fn()} onConfirm={onConfirm} />
    )
