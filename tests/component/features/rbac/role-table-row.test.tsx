...
import { Table, TableBody } from '../../../../packages/renderer/src/components/ui/table'
import { RoleTableRow } from '../../../../packages/renderer/src/features/rbac/components/role-table-row'
import { createMockRole, createSystemRole } from '../../../shared/factories/rbac.fixture'
...
describe('RoleTableRow', () => {
  it('renders role displayName, user count, and status badge', () => {
    ...
    render(
      <TableWrapper>
        <RoleTableRow {...defaultProps} role={role} userCount={5} />
      </TableWrapper>
    )
  ...
  it('calls onToggleSelected when checkbox clicked', async () => {
    ...
    render(
      <TableWrapper>
        <RoleTableRow {...defaultProps} role={role} onToggleSelected={onToggleSelected} />
      </TableWrapper>
    )
  ...
  it('calls onViewUsers when View Users menu item clicked', async () => {
    ...
    render(
      <TableWrapper>
        <RoleTableRow {...defaultProps} role={role} onViewUsers={onViewUsers} />
      </TableWrapper>
    )
